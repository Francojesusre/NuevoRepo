...
namespace eSignature.Examples
{
    ...
    public static class EmbeddedSigningCeremony
    {
        ...
        private static EnvelopeDefinition MakeEnvelope(string signerEmail, string signerName, string signerClientId, string docPdf)
        {
            ...
            envelopeDefinition.EmailSubject = "Por favor firme el documento";
            Document doc1 = new Document();

            String doc1b64 = Convert.ToBase64String(buffer);

            doc1.DocumentBase64 = doc1b64;
            doc1.Name = "Boleto"; // can be different from actual file name
            ...
            {
                AnchorString = "_____________________________",
                AnchorUnits = "pixels",
                AnchorXOffset = "20",
                AnchorYOffset = "20"
            };
